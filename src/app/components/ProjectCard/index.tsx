...
export default function ProjectCard() {
  return (
    <>
      <div className='m-4 transition ease-in-out delay-150  hover:-translate-y-5 duration-300'>
        <a href="#" className="flex flex-col items-center rounded-lg md:flex-row md:max-w-xl bg-dark shadow-2xl">
